...
export default function ShopClient({ data }: ShopClientProps) {
    ...
    <div className="container mx-auto px-6 md:px-12 py-12 md:py-24">
      <div className="flex flex-col gap-12">
        ...
        <div className="space-y-4 max-w-2xl">
          ...
          <h1 className="text-4xl md:text-5xl font-sans font-bold text-zinc-900 leading-tight">
            Original Collection
          </h1>
          <p className="text-base md:text-lg text-zinc-500 font-sans leading-relaxed">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-zinc-100 pb-8">
          <Tabs defaultValue="all" onValueChange={setFilter} className="w-full md:w-auto">
            <TabsList className="bg-transparent h-auto p-0 gap-8 flex-wrap justify-start">
              <TabsTrigger 
                value="all" 
                className="data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:text-zinc-900 text-zinc-400 p-0 text-xs tracking-[0.2em] uppercase font-sans border-b-2 border-transparent data-[state=active]:border-zinc-900 rounded-none h-10 transition-all font-bold focus-visible:ring-0"
              >
                All Works
              </TabsTrigger>
              <TabsTrigger 
          ...
          <div className="flex items-center gap-4 text-zinc-500 text-sm font-sans font-medium">
        ...
        {filteredArtworks.length === 0 && (
          ...
          >
            <p className="text-zinc-400 font-sans text-lg">No pieces found in this category.</p>
            <button 
